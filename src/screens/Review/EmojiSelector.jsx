...
const REACTIONS = [
  { label: "Worst", src: require('../../assets/emoji/worried.png'), bigSrc: require('../../assets/emoji/worried_big.png') },
  { label: "ok", src: require('../../assets/emoji/sad.png'), bigSrc: require('../../assets/emoji/sad_big.png') },
  { label: "good", src: require('../../assets/emoji/ambitious.png'), bigSrc: require('../../assets/emoji/ambitious_big.png') },
  { label: "Happy", src: require('../../assets/emoji/smile.png'), bigSrc: require('./../../assets/emoji/smile_big.png') },
  { label: "Surprised", src: require('../../assets/emoji/surprised.png'), bigSrc: require('../../assets/emoji/surprised_big.png') },
];
const WIDTH = 320;
